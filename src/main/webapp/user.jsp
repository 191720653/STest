...
<html>  
  ...
  <body>  
    <h1>${message }</h1>  
    <h1>用户列表--<a href="/STest/user/add">添加用户</a>---<a href="/STest/logout">退出登录</a>    </h1> 
    <h2>权限列表</h2>  
    ...
    <ul>  
        <c:forEach items="${userList }" var="user">  
            <li>用户名：${user.username }----密码：${user.password }----<a href="/STest/user/edit/${user.id}">修改用户</a>----<a href="javascript:;" class="del" ref="${user.id }">删除用户</a></li>  
        </c:forEach>  
    </ul>  
    <img alt="" src="/STest/static/img/1.jpg">  
